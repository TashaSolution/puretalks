  ...
  return (
    <>
      ...
      <motion.div
        ...
        className="absolute -top-6 -left-4 sm:left-4 z-20 p-3.5 rounded-2xl bg-white/90 border border-black/[0.08] shadow-card flex items-center gap-3 animate-float-slow backdrop-blur-xl"
      >
      ...
      <motion.div
        ...
        className="absolute -bottom-6 -right-2 sm:right-4 z-20 p-4 rounded-2xl bg-white/95 border border-[#C5A869]/30 shadow-card flex items-center gap-3.5 animate-float-delayed backdrop-blur-xl max-w-[260px]"
      >
      ...
      <motion.div
        ...
        className="absolute bottom-4 left-6 z-20 px-3.5 py-1.5 rounded-full bg-white/90 border border-black/[0.08] shadow-sm backdrop-blur-md flex items-center gap-2 text-[11px] text-[#4B5563] font-medium"
      >
